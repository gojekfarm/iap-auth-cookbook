...
default['iap-auth']['version'] = ENV['IAP_AUTH_VERSION'] || 'v0.1.0'

default['iap-auth']['release_gz_file'] = "iap_auth_#{node['iap-auth']['version']}_Linux_x86_64.tar.gz"
default['iap-auth']['github_release_url'] = "https://github.com/gojekfarm/iap_auth/releases/download/#{node['iap-auth']['version']}/#{node['iap-auth']['release_gz_file']}"
